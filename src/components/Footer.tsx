            ...
            <div className="flex flex-col sm:flex-row gap-8 items-start">
              ...
              <div className="space-y-5">
                ...
                <div className="flex items-center gap-6 pt-2">
                  <a href="https://www.facebook.com/mymahakaal/" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-[#1877F2] transition-colors duration-300 hover:scale-110 transform">
