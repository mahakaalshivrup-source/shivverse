      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-6 right-6 w-[340px] md:w-96 h-[520px] z-50 flex flex-col rounded-2xl overflow-hidden bg-[#0a0a0a]/95 backdrop-blur-xl border border-white/10 shadow-[0_0_40px_rgba(0,75,122,0.3)]"
          >
            {}
